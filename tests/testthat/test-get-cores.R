...
test_that("With parallel", {
  ...
  expect_equal(SticsOnR:::get_cores_nb(parallel = TRUE,
...
test_that("With forcing cores number", {
  ...
  # with required
  # required < available
  expect_equal(SticsOnR:::get_cores_nb(parallel = TRUE, required_nb = 1,
                                       cores_nb = 2 ), 1)
  expect_equal(SticsOnR:::get_cores_nb(parallel = TRUE, required_nb = 2,
                                       cores_nb = 3 ), 2)
  expect_equal(SticsOnR:::get_cores_nb(parallel = TRUE, required_nb = 3,
                                       cores_nb = 4 ), 3)
  # required == available
  expect_equal(SticsOnR:::get_cores_nb(parallel = TRUE, required_nb = 1,
                                       cores_nb = 1 ), 1)
  ...
  expect_equal(SticsOnR:::get_cores_nb(parallel = TRUE, required_nb = 3,
                                       cores_nb = 3 ), 2)
  expect_equal(SticsOnR:::get_cores_nb(parallel = TRUE, required_nb = 4,
                                       cores_nb = 4 ), 3)
  # required > available
  expect_equal(SticsOnR:::get_cores_nb(parallel = TRUE, required_nb = 2,
                                       cores_nb = 1 ), 1)
  ...
  expect_equal(SticsOnR:::get_cores_nb(parallel = TRUE, required_nb = 4,
                                       cores_nb = 3 ), 2)
  expect_equal(SticsOnR:::get_cores_nb(parallel = TRUE, required_nb = 5,
                                       cores_nb = 4 ), 3)
