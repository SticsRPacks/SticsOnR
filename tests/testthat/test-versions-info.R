test_that("Get the version hash, date from the exe info", {
  ...
  testthat::expect_equal(
    SticsOnR:::extract_version_hash(version_line),
    "b09f41236"
  )
  testthat::expect_equal(
    SticsOnR:::extract_version_date(version_line),
    "2026-02-17"
  )
...
test_that("Get the full version from number or string", {
  testthat::expect_equal(SticsOnR:::complete_version(10.5), "10.5.0")
  testthat::expect_equal(SticsOnR:::complete_version("10.5"), "10.5.0")
...
test_that("Get the version hash from the exe info", {
  ...
  testthat::expect_equivalent(SticsOnR:::get_version(version_line), num_version)
