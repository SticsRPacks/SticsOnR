...
[![Travis-CI Build Status](https://travis-ci.com/packs4stics/SticsOnR.svg?branch=master)](https://travis-ci.com/packs4stics/SticsOnR)
[![AppVeyor Build status](https://ci.appveyor.com/api/projects/status/cu1nyxrhc6nmpt5i/branch/master?svg=true)](https://ci.appveyor.com/project/packs4stics/SticsOnR/branch/master)
