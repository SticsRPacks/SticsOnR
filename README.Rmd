...
output:
  github_document:
   html_preview: true
params:
  javastics_dist: 'JavaSTICS-v11.0.0'
  java_cmd: 'java'
  root_path: '/tmp'
  work_dir: 'example'
...
* for JavaStics from version 10.4.0 to 11.0.0 version, the java version must be at least a Java 17 version

> Note: After the JavaStics Version 1.5.3, STICS version 10.3.0 the release number has changed, a unique version
> has been chosen for JavaSTICS and STICS using the STICS version number only.
