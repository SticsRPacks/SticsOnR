...
if (!is.null(try_err) && attr(try_err,"class") == "try-error") {
  ver <- system2(command = 'java', args = "-version", stdout = TRUE, stderr = TRUE)
  stop(javastics_dist, ": javastics not compatible with java\n",
       ver[1],
       "\nA java path must be provided for a compatible java version (11) to run_javastics")
}
...
### Running the model using JavaStics command line interface {#runjavasticscmd}
