...
output:
  github_document:
   html_preview: true
params:
  javastics_path: /home/plecharpent/Work/projet_tests_modulostics/JavaSTICS-1.41-stics-9.1
  workspace_path: /home/plecharpent/Work/projet_tests_modulostics/JavaSTICS-1.41-stics-9.1/example
...
javastics_path <- "D:/OneDrive - cirad.fr/Travail_Postdoc/STICS/JavaSTICS-v85"
workspace_path <- "D:/OneDrive - cirad.fr/Travail_Postdoc/STICS/JavaSTICS-v85/example"
output_path <- "D:/OneDrive - cirad.fr/Travail_Postdoc/STICS/JavaSTICS-v85/output"
```
...
1. if its already listed in the preference (e.g. added in JavaStics), simply provide its name (ID): 
...
1. if its located in the bin directory of the JavaStics installation directory, provide the executable name: 
...
1. if its located in any other folder, provide the full path to the executable name, and no need to use `javastics_path`: 
