...
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/packs4stics/SticsOnR?branch=master&svg=true)](https://ci.appveyor.com/project/packs4stics/SticsOnR)
