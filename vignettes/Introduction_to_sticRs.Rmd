...
The [SticsOnR](https://packs4stics.github.io/SticsOnR/) package provides tools for [STICS](https://www6.paca.inra.fr/stics_eng/) developers and users.  
...
This vignette is meant to introduce the concepts of STICS development and parameterization using the [SticsOnR](https://packs4stics.github.io/SticsOnR/) package.
...
It is strongly encouraged to use your own data instead of the dummy data set. The [SticsOnR](https://packs4stics.github.io/SticsOnR/) package uses the above-mentioned files, so if you want to use your own data, you simply have to create a USM using javaSTICS for example, and to make a first run with it to create all files needed. After completion, it is encouraged to copy the folder to a new location before using [SticsOnR](https://packs4stics.github.io/SticsOnR/), or to use a version control system such as GIT to avoid overwriting a USM when re-opening javaSTICS.
...
The package also has a function to make sensitivity analyses: `sensitive_stics`. Its usage is detailed in a [separate vignette](https://packs4stics.github.io/SticsOnR/articles/Sensitivity_analyses.html) for a clearer description.
