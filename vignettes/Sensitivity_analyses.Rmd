...
Sensitivity analyses are critical steps for model evaluation. This step is often complicated because it is hard to implement and hard to understand. One purpose of the [SticsOnR](https://github.com/packs4stics/SticsOnR) package is to make this step easy by abstracting all the complex code and reduce it to only one main function.
