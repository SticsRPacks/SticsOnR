...
#'
#' @description Looking in JavaStics for a workspace path
#' in JavasStics preferences
...
#' @param javastics_workspace_path An absolute or relative path
#' (to JavaStics path) of a workspace (Optional)
#'
...
check_java_workspace <- function(javastics_path,
  ...
  # Ensure that the user working directory is unchanged
